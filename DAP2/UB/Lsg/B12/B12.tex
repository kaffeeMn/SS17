...
\subsubsection \
Im folgendem werden die Resultate nach jedem Durchlauf $dL_i$ der While-Schleife angegeben.\\
\\
...
neu sortieren und landen damit in O(n*log(n)), unter Verwendung eines angepassten merge-sort Algorithmus.
\end{document}
